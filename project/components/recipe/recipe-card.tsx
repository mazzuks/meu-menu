...
// Special dates calendar / Calendário de datas especiais
export const specialDates: SpecialDate[] = [
  {
    ...
    themeColor: '#FFD700',
    recipes: ['5'], // Feijoada
    description: 'Comece o ano com sorte! Lentilha e uva não podem faltar.'
  },
  {
    date: '02-14',
    ...
    themeColor: '#FF69B4',
    recipes: ['15'], // Tiramisù
    description: 'Surpreenda seu amor com uma sobremesa especial!'
  },
  {
    date: '06-12',
    title: 'Dia dos Namorados (Brasil)',
    themeColor: '#FF1493',
    recipes: ['4', '15'], // Brigadeiro e Tiramisù
    description: 'Doces especiais para adoçar o romance!'
  },
  {
    date: '10-31',
    title: 'Halloween',
    themeColor: '#FF8C00',
    recipes: ['2'], // Sopa de Abóbora
    description: 'Receitas assombrosamente deliciosas!'
  },
  {
    date: '12-25',
    title: 'Natal',
    themeColor: '#DC143C',
    recipes: ['7', '19'], // Lasanha e Cheesecake
    description: 'Sabores especiais para a ceia natalina!'
  }
]

// Mock shopping list / Lista de compras mockada
export const mockShoppingList: ShoppingListItem[] = [
  { id: '1', name: 'Tomate', amount: '1', unit: 'kg', category: 'Hortifruti', purchased: false },
  { id: '2', name: 'Mussarela', amount: '200', unit: 'g', category: 'Laticínios', purchased: true },
  { id: '3', name: 'Massa de pizza', amount: '1', unit: 'pacote', category: 'Massas', purchased: false },
  { id: '4', name: 'Manjericão', amount: '1', unit: 'maço', category: 'Hortifruti', purchased: false },
  { id: '5', name: 'Azeite', amount: '1', unit: 'garrafa', category: 'Condimentos', purchased: true }
]

// Mock expenses / Gastos mockados
